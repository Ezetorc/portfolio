...
export const DICTIONARY = {
  en: {
    ...
    "work.vibe-network.image.1.alt": "Vibe Network Register Page",
    "work.vibe-network.image.2.alt": "Vibe Network Posts Page",
  ...
  es: {
    ...
    "work.vibe-network.image.1.alt": "Página de registro de Vibe Network",
    "work.vibe-network.image.2.alt": "Página de publicaciones de Vibe Network",
    "work.frontend": "Frontend",
    "work.backend": "Backend",
    ...
    "technology.vite.name": "Vite",
    "technology.vite.description": "Herramienta de construcción",
    "technology.mysql.name": "MySQL",
