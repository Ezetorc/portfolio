<svg width="42px" height="42px" viewBox="0 0 16 16" fill="none"
  ><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
    ...
    <defs>
      ...
      >
        <stop offset="0" stop-color="#BDF8FF"></stop>
        <stop offset="1" stop-color="#7EB6EE"></stop>
      </linearGradient>
    </defs>
